  ...
  en: {
    ...
    variants: {
      bottleneck: {
        ...
        calculation: 'The relative score gap is the absolute CPU/GPU score difference divided by the higher score. A gap of five score points or less is classified as balanced.',
        formula: 'Relative gap = |CPU score − GPU score| ÷ max(CPU score, GPU score) × 100',
  ...
  it: {
    ...
    variants: {
      bottleneck: {
        ...
        calculation: 'Il divario relativo è la differenza assoluta tra i punteggi divisa per quello maggiore. Fino a cinque punti di differenza il sistema è classificato come bilanciato.',
        formula: 'Divario relativo = |punteggio CPU − punteggio GPU| ÷ punteggio maggiore × 100',
  ...
  fr: {
    ...
    variants: {
      bottleneck: {
        ...
        calculation: 'L’écart relatif est la différence absolue divisée par le score le plus élevé. Cinq points d’écart ou moins sont classés comme équilibrés.',
        formula: 'Écart relatif = |score CPU − score GPU| ÷ score le plus élevé × 100',
  ...
  de: {
    ...
    variants: {
      bottleneck: {
        ...
        calculation: 'Die relative Lücke ist die absolute Wertdifferenz geteilt durch den höheren Wert. Bis zu fünf Punkte Unterschied gelten als ausgeglichen.',
        formula: 'Relative Lücke = |CPU-Wert − GPU-Wert| ÷ höherer Wert × 100',
  ...
  es: {
    ...
    variants: {
      bottleneck: {
        ...
        calculation: 'La diferencia relativa es la distancia absoluta entre puntuaciones dividida por la mayor. Cinco puntos o menos se clasifican como equilibrados.',
        formula: 'Diferencia relativa = |puntuación CPU − puntuación GPU| ÷ puntuación mayor × 100',
