...
const LEGAL_COPY: Record<Locale, LegalLocaleCopy> = {
  ...
  ru: {
    terms: {
      ...
      description: "Прочтите Условия использования PCBuildCheck, включая ограничения и обязанности пользователя.",
      lastUpdated: "Последнее обновление",
      displayDate: "14 июля 2026 г.",
      intro: "Добро пожаловать в PCBuildCheck. Получая доступ и используя pcbuildcheck.com, вы соглашаетесь с настоящими Условиями. Если вы не согласны с какой-либо частью из них, пожалуйста, не пользуйтесь нашими услугами.",
      sections: [
        { title: "1. Использование Сервиса", paragraphs: ["PCBuildCheck предоставляет бесплатные онлайн-инструменты, в том числе калькулятор узких мест ПК, FPS оценщик и PSU калькулятор, только для информационных и образовательных целей. Результаты представляют собой оценки, основанные на спецификациях производителя и внутренне нормализованных сравнительных показателях; они не являются измеряемыми показателями и могут не отражать точную реальную производительность."] },
        { title: "2. Интеллектуальная собственность", paragraphs: ["Весь контент, включая текст, графику, логотипы, значки и программное обеспечение, является собственностью PCBuildCheck или его поставщиков контента и защищен применимыми законами об авторских правах. Вы не имеете права воспроизводить, распространять или создавать производные работы без предварительного письменного согласия."] },
        { title: "3. Точность информации", paragraphs: ["Хотя мы стремимся предоставлять точную и актуальную информацию, мы не даем никаких гарантий относительно точности, полноты и надежности содержимого сайта. Технические характеристики оборудования и данные о производительности могут со временем меняться."] },
        { title: "4. Ограничение ответственности", paragraphs: ["PCBuildCheck не несет ответственности за прямой, косвенный, случайный, косвенный или штрафной ущерб, возникший в результате использования или невозможности использования веб-сайта или его инструментов. Сюда входят решения о покупке, основанные на результатах калькулятора."] },
        { title: "5. Внешние ссылки", paragraphs: ["Наш веб-сайт может содержать ссылки на внешние веб-сайты, которыми мы не управляем. Мы не контролируем их контент или действия и не несем ответственности за их политику конфиденциальности или другую деятельность."] },
        { title: "6. Изменения в Условиях", paragraphs: ["Мы можем изменить или заменить настоящие Условия в любое время. Существенные изменения появятся на этой странице с измененной датой. Продолжение использования сайта после внесения изменений означает, что вы принимаете обновленные Условия."] },
      ],
      contactTitle: "7. Контакт",
      contactPrefix: "Если у вас есть вопросы по поводу настоящих Условий, пожалуйста, ",
      contactLink: "свяжитесь с нами",
      contactSuffix: ".",
    },
    'cookie-policy': {
      title: "Политика использования файлов cookie",
      description: "Узнайте, как PCBuildCheck использует файлы cookie для управления сайтом, запоминания предпочтений, анализа трафика и показа рекламы с согласия.",
      lastUpdated: "Последнее обновление",
      displayDate: "14 июля 2026 г.",
      intro: "В настоящей Политике использования файлов cookie объясняется, как PCBuildCheck («мы», «нас» или «наш») использует файлы cookie и аналогичные технологии, когда вы посещаете pcbuildcheck.com.",
      sections: [
        { title: "1. Что такое файлы cookie?", paragraphs: ["Файлы cookie — это небольшие текстовые файлы, сохраняемые на вашем устройстве при посещении веб-сайта. Они помогают веб-сайтам работать эффективно, запоминать предпочтения и предоставлять аналитическую информацию."] },
        { title: "2. Файлы cookie, которые мы используем", paragraphs: ["Основные файлы cookie: они необходимы для функционирования веб-сайта и включают файлы cookie сеанса, темы и языковых предпочтений.", "Аналитические файлы cookie: если они включены с необходимого согласия, аналитические службы помогают нам понять просмотры страниц, продолжительность сеанса и то, как посетители используют сайт.", "Рекламные файлы cookie. Если реклама включена после получения необходимого согласия, Google AdSense может установить файлы cookie. Реклама в этом проекте отключена по умолчанию, пока эта настройка не будет явно включена."] },
        { title: "3. Сторонние файлы cookie", paragraphs: ["Дополнительные сторонние службы могут размещать файлы cookie только в том случае, если эти службы включены. Поставщики могут включать в себя рекламные или аналитические службы Google. Обычные ссылки на Facebook или Instagram сами по себе не устанавливают файлы cookie на этом сайте."] },
        { title: "4. Управление файлами cookie", paragraphs: ["Большинство браузеров позволяют удалять существующие файлы cookie, блокировать новые файлы cookie или получать уведомление при установке файлов cookie. Отключение основных файлов cookie может повлиять на функциональность сайта."] },
        { title: "5. Изменения в настоящей Политике", paragraphs: ["Мы можем время от времени обновлять настоящую Политику использования файлов cookie. Изменения появятся на этой странице с указанной датой."] },
      ],
      consent: { afterSection: 3, prefix: "Вы также можете управлять настройками согласия через наш ", link: "менеджер согласия", suffix: "." },
      contactTitle: "6. Контакт",
      contactPrefix: "Если у вас есть вопросы о нашей практике использования файлов cookie, пожалуйста, ",
      contactLink: "свяжитесь с нами",
      contactSuffix: ".",
    },
    disclaimer: {
      title: 'Disclaimer',
      description: "Ознакомьтесь с ограничениями узких мест PCBuildCheck, калькуляторов FPS и PSU и предоставляемой нами информации.",
      lastUpdated: "Последнее обновление",
      displayDate: "14 июля 2026 г.",
      sections: [
        { title: "Общая информация", paragraphs: ["Информация на pcbuildcheck.com предоставлена ​​в общих информационных и образовательных целях. Результаты калькулятора, включая процент узких мест, расчетные FPS и рекомендации PSU, представляют собой приблизительные значения, основанные на опубликованных спецификациях и нормализованных результатах сравнения, а не на агрегированных лабораторных показателях или гарантированных измерениях."] },
        { title: "Никаких профессиональных советов", paragraphs: ["Ничто на этом веб-сайте не является профессиональным советом по оборудованию, рекомендацией по покупке или технической консультацией. Перед покупкой внимательно изучите компоненты и проверьте официальные спецификации производителя."] },
        { title: "Точность данных", paragraphs: ["Мы стремимся поддерживать актуальность данных об оборудовании, но реальная производительность зависит от драйверов, версий BIOS, охлаждения, оптимизации программного обеспечения и других факторов. Мы не гарантируем, что каждый элемент является точным, полным или актуальным."] },
        { title: "Отказ от ответственности для партнеров и рекламы", paragraphs: ["Если реклама включена, PCBuildCheck может отображать рекламу Google AdSense. Сообщения в блоге могут содержать явно раскрытые партнерские ссылки. Рекламные и партнерские отношения не влияют на формулы калькулятора или выводы редакции."] },
        { title: "Внешние ссылки", paragraphs: ["Для удобства наш сайт может ссылаться на сторонние сайты. Ссылка не означает одобрения, и мы не несем ответственности за внешний контент, точность или практику."] },
      ],
      contactTitle: 'Contact',
      contactPrefix: "Если у вас есть вопросы по поводу данного отказа от ответственности, пожалуйста, ",
      contactLink: "свяжитесь с нами",
      contactSuffix: ".",
    },
  },
