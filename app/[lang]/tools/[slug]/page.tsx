...
const VRAM_EDUCATION: Record<Locale, VramEducationCopy> = {
  ...
  ru: {
    title: "Выделенный VRAM не совпадает с требуемым VRAM",
    intro: "Программное обеспечение для мониторинга может показывать память, зарезервированную игрой, но это значение само по себе не доказывает, что игре необходим каждый выделенный гигабайт для бесперебойной работы.",
    allocatedTitle: "Выделенная память",
    allocatedBody: "Память, зарезервированная игрой или драйвером. Механизмы могут сохранять свободную мощность и кэшированные активы, когда доступно больше VRAM.",
    workingTitle: "Активный рабочий набор",
    workingBody: "Ресурсы, активно необходимые для текущей сцены и настроек. Это ближе к практическому спросу, но большинство наложений не могут его точно измерить.",
    pressureTitle: "Давление производительности",
    pressureBody: "Повторяемые скачки времени кадра, всплывающие текстуры или принудительное уменьшение текстур, которые улучшаются при уменьшении настроек, требующих большого объема памяти.",
    verifyTitle: "Как проверить давление VRAM",
    verifyIntro: "Используйте оценку в качестве плана тестирования, а затем сравните аналогичные прогоны.",
    checks: ["Сохраните ту же версию игры, сцену, драйвер и фоновые приложения.", "Рекордное время кадра, минимум 1%, выделенный VRAM и системный RAM, а не средний FPS один.", "Сначала уменьшите текстуры, сохранив разрешение и другие настройки без изменений.", "Повторите тот же маршрут или тест и ищите последовательное улучшение, а не одиночный скачок."],
    guideLink: "Прочтите полное руководство по планированию VRAM.",
    fpsLink: "Оцените FPS с помощью CPU и GPU.",
  },
};
